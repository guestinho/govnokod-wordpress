<?php
/**
 * $URL: https://govnokod.googlecode.com/svn/trunk/govnoquoter/app/service/bbcode.php $
 *
 ...
 * @package system
 * @subpackage toolkit
 * @version $Id: bbcode.php 284 2009-10-18 04:09:59Z wiistriker $
 */
...
class bbcode
{
    ...
    */
    ...
    protected function handleCode($code, $lang = 'text')
    {
        ...
        $code = trim(str_replace(array('<br>', '<br />'), '', $code));
    ...
    protected function buildSmileys()
    {
        ...
        $html = '<img src="' . '/templates/images/smiles/%1$s.gif" alt="%2$s" />';
